package com.rpm.realmexamples.adapters;
...
import com.rpm.realmexamples.activities.MainActivity;
import com.rpm.realmexamples.models.Person;

import java.util.ArrayList;

/**
 * Created by RPM on 03/05/16.
 */
public class PersonDetailsAdapter extends BaseAdapter {

    private ArrayList<Person> personDetailsArrayList;
    private Context context;
    private LayoutInflater inflater;

    public PersonDetailsAdapter(Context context, ArrayList<Person> personDetailsArrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.ivEditPesonDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Person dataToEditModel = MainActivity.getInstance().searchPerson(personDetailsArrayList.get(position).getId());
    ...
    public static void ShowConfirmDialog(Context context, final String personId, final int position) {
